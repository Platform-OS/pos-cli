...
const ServerError = {
  ...
  unauthorized: request => {
    ...
    logger.Error('You are unauthorized to do this operation. Check if your Token and URL is correct.', { hideTimestamp: true });
  },
  ...
  internal: request => {
    ...
    logger.Error('Something went wrong on the server. \nWe have been notified about it.', { hideTimestamp: true, exit: shouldExit(request) });
  },
