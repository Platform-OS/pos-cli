...
class Gateway {
  ...
  cloneInstanceStatus(id) {
    return this.apiRequest({ method: 'GET', uri: `${this.api_url}/instance_clone_imports/${id}` });
  }

  cloneInstanceInit(formData = {}) {
    return this.apiRequest({ method: 'POST', uri: `${this.api_url}/instance_clone_imports`, json: formData });
  }

  cloneInstanceExport(formData = {}) {
    return this.apiRequest({ method: 'POST', uri: `${this.api_url}/instance_clone_exports`, json: formData });
  }
  ...
  test(name) {
    return this.apiRequest({ uri: `${this.url}/_tests/run.js?name=${name}` });
  }

  testRunAsync() {
    return this.apiRequest({ uri: `${this.url}/_tests/run_async` });
  }
