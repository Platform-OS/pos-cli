...
//
// Zero imports on purpose: the gui/next bundle is a separate package built by its
// own vite and pulls this in by relative path.
// Anything Node-only added here would break that build.
