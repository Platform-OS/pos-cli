...
const resolveDependencies = async (modules, getVersions) => {
  ...
  const dependenciesVersions = resolveBestVersion(dependenciesList, getVersions);
  const dependenciesDependencies = resolveDependencies(dependenciesVersions, getVersions);
