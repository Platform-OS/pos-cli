...
const tags = require('../lib/audit/tags'),
  ...
  fileName = require('./audit/fileName'),
  orphanedIncludes = require('../lib/audit/orphanedIncludes'),
  formIds = require('./audit/formIds');

const auditors = [tags, filters, detailed, extensions, duplicateFile, fileName, formIds, orphanedIncludes];
