...
//
// Re-exported: `logs-fetch` (mcp-min/logs/fetch.js) publishes the same shape, so the cursor has one
// type wherever it travels. The pattern itself lives with the ordering that has to agree with it.
import { ROW_ID } from '../../logRowId.js';
