...
// The methods both backends send to stdout. In server mode stdout is the MCP JSON-RPC channel, so
// a Partner Portal retry notice or a two-factor message arriving mid-response is malformed JSON to
// the client. They still get written, on stderr, where MCP clients collect a server's output.
