...
/**
 * One reading of a `/_tests/results/:id` body, shared by `tests-run-async-result` and `job-status`.
 *
 * A run whose assertions failed is finished — it did what it was asked to; only the runner going
 * down is a failure of the job itself.
 */
...
/** The run, with its counters as numbers and the three questions a caller asks. */
