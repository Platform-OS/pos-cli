...
program
  ...
  .command('install [module-name]', 'Add new modules and resolve dependencies from pos-modules.json')
  .command('update <module-name>', 'Update module to the newest version and resolve dependencies from pos-modules.json')
