import{g as o}from"./graphql.vANW7X3L.js";const n={get:async e=>{let t="";e?.id&&(t=`id: { value: "${e.id}" }`);let a="";e?.type&&(a=`type: ${e.type}`);const r=`
      query {
      ...
      }`;return o({query:r}).then(i=>i.admin_background_jobs)},delete:async e=>{const r=`
      mutation {
    ...
    `;return o({query:r})}};export{n as b};
